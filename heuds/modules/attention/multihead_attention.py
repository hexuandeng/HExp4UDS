...
class MultiheadAttention(FairseqIncrementalDecoder, BaseAttention):
    def __init__(
        self,
        embed_dim,
        num_heads,
    ...
    def forward(
        ...
        if key is not None:
            ...
            assert value is not None or before_softmax
            assert src_len, key_bsz == value.shape[:2] or before_softmax
